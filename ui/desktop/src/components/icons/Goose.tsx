// OpenSearch-themed mark used wherever the original goose silhouette appeared.
// Keeping the export name `Goose` so call sites elsewhere don't break.
    ...
    >
      <g transform="translate(12 12)">
        <circle
          ...
          transform="rotate(-30)"
        />
        <circle cx="6.8" cy="-4" r="1.6" fill="currentColor" />
      </g>
    </svg>
  );
}
