...
#[openapi(
    paths(
        ...
        super::routes::setup::aws_idc_start,
        super::routes::setup::aws_idc_accounts,
        super::routes::setup::aws_idc_roles,
        super::routes::setup::aws_idc_complete,
        super::routes::setup::aws_default_probe,
        super::routes::setup::aws_midway_status,
        super::routes::setup::aws_midway_login,
    ...
    components(schemas(
        ...
        super::routes::setup::AwsIdcStartRequest,
        super::routes::setup::AwsIdcStartResponse,
        super::routes::setup::AwsIdcCompleteRequest,
        super::routes::setup::AwsDefaultProbeResponse,
        super::routes::setup::MidwayStatusResponse,
        super::routes::setup::MidwayLoginRequest,
        super::routes::setup::MidwayLoginResponse,
        super::routes::setup::AdaProvider,
